...
$kosten = $db->query("SELECT COALESCE(SUM(amount),0) FROM expenses")->fetchColumn();
$winst = $omzet - $kosten;
...
<div class="tile">
<h2>🌱 Teelten</h2>
<p id="batches"><?= $teelten ?></p>
</div>

<div class="tile">
<h2>📦 Voorraad</h2>
<p id="inventory"><?= $voorraad ?></p>
</div>

<div class="tile">
<h2>📋 Producten</h2>
<p id="products"><?= $producten ?></p>
</div>

<div class="tile">
<h2>💰 Verkopen</h2>
<p id="sales"><?= $verkopen ?></p>
</div>

<div class="tile">
<h2>👥 Klanten</h2>
<p id="customers"><?= $klanten ?></p>
</div>

<div class="tile">
<h2>🚚 Leveranciers</h2>
<p id="suppliers"><?= $leveranciers ?></p>
</div>

<div class="tile">
<h2>🌾 Oogsten</h2>
<p id="harvests"><?= $oogsten ?></p>
</div>

<div class="tile">
<h2>⚠️ Lage voorraad</h2>
<p><?= $lageVoorraad ?></p>
</div>

<div class="tile">
<h2>💶 Omzet</h2>
<p id="revenue">€<?= number_format($omzet,2) ?></p>
</div>

<div class="tile">
<h2>💸 Kosten</h2>
<p id="expenses">€<?= number_format($kosten,2) ?></p>
</div>

<div class="tile">
<h2>📈 Winst</h2>
<p id="profit">€<?= number_format($winst,2) ?></p>
</div>
