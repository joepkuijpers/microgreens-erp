<?php
/**
 * Module: b04_rack_capacity.php
 * Doel: Toont bezetting van de rekken per positie
 * Engine: rack_capacity_engine.php
 */
...
// 2. Engine laden
require_once __DIR__ . '/../includes/rack_capacity_engine.php';
