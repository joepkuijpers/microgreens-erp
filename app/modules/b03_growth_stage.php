<?php
/**
 * Module: b03_growth_stage.php
 * Doel: Berekent de huidige groeifase (blackout, groei, oogst)
 * Engine: growth_stage_engine.php
 */
...
// 2. Engine laden
require_once __DIR__ . '/../includes/growth_stage_engine.php';
