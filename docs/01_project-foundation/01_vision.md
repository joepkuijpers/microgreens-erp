...
This document defines the long-term vision of the Microgreens ERP project.

It describes the future the project aims to help create and provides the foundation for long-term strategic decision-making.

## Vision

A food chain that is honest, transparent and sustainable.

A food chain in which every stage exists as part of one interconnected ecosystem that creates balance between people, plants, animals and nature.
...
A food chain in which transparency is the standard, allowing people to understand where food comes from, how it is produced and why every decision is made.
