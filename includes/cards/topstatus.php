<div class="top-status-bar">
    ...
    <span>🧠 <?= __('ram') ?>: <strong id="topRam">--</strong></span>
    <span>💽 <?= __('disk') ?>: <strong id="topDisk">--</strong></span>
    <span>🔄 <strong id="topRefresh">--</strong></span>
    <span>🕒 <strong id="topClock">--</strong></span>
</div>